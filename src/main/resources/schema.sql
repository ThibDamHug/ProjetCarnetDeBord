...
<<<<<<< HEAD
-- Mon May  8 11:04:25 2017
=======
-- Mon May  1 20:05:57 2017
...
=======
CREATE UNIQUE INDEX `mailperso_UNIQUE` ON `projetfinal`.`user` (`persomail` ASC);
>>>>>>> refs/remotes/origin/master
...
CREATE UNIQUE INDEX `email_UNIQUE` ON `projetfinal`.`user` (`email` ASC);
...
CREATE TABLE IF NOT EXISTS `projetfinal`.`answer` (
  ...
  CONSTRAINT `fk_answer_question1`
    ...
    REFERENCES `projetfinal`.`question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_answer_question1_idx` ON `projetfinal`.`answer` (`question_id` ASC);
